...
export class RestAPIStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    //Functions
    const getCrewRoleByMovieFn = new lambdanode.NodejsFunction(
      this,
      "GetCrewByRoleFn",
      {
        architecture: lambda.Architecture.ARM_64,
        runtime: lambda.Runtime.NODEJS_18_X,
        entry: `${__dirname}/../lambdas/getCrewRoleByMovieID.ts`,
    ...
    moviesTable.grantReadData(getCrewRoleByMovieFn);
    movieCastsTable.grantReadData(getCrewRoleByMovieFn);
  }
}
